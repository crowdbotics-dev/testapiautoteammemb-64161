...
## Project Structure
    ...
    ├── testapiautoteammemb_64161  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_64161`
...
2. Clone this repo and `cd testapiautoteammemb_64161`
